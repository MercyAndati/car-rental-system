...
public class CarRentalSystem {
    public static void main(String[] args) {
        ...
        Car car1 = new Car("Toyota   ", "Camry    ", 2020, 60.0, "ABC123");
        Car car2 = new Car("Honda    ", "Accord   ", 2021, 65.0, "DEF456");
        Car car3 = new Car("Ford     ", "Mustang  ", 2019, 75.0, "GHI789");
        Car car4 = new Car("Chevrolet", "Silverado", 2022, 80.0, "JKL012");
        Car car5 = new Car("BMW      ", "3 Series ", 2018, 90.0, "MNO345");
        agency.addCar(car1);
        agency.addCar(car2);
        agency.addCar(car3);
        agency.addCar(car4);
